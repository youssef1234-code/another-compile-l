...
} from "@/components/generic/GenericForm";
      ...
      conditionalAlerts={[
        {
          ...
          title: "What's next?",
          message:
            "After registration, your account will be reviewed by administrators. Once approved, you can participate in bazaars and booth setups.",
        },
      ]}
    />
  );
