...
export const designSystem = {
  ...
  eventTypes: {
    ...
    BAZAAR: 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-400',
    CONFERENCE: 'bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400',
    GYM_SESSION: 'bg-pink-100 text-pink-800 dark:bg-pink-900/30 dark:text-pink-400',
