...
export const NotificationType = {
  ...
  VENDOR_POLL_CREATED: "VENDOR_POLL_CREATED",
...
export type RegistrationForEventResponse = z.infer<
  typeof RegistrationForEventResponseSchema
>;
...
export const CreateVendorPollSchema = z.object({
  boothLocationId: z.string(),
  boothLabel: z.string().optional(),
  startDate: z.coerce.date(),
  duration: z.number().min(1).max(4),
  applicationIds: z.array(z.string()).min(2),
  description: z.string().optional(),
});
export type CreateVendorPollSchema = z.infer<typeof CreateVendorPollSchema>;

export const VoteOnPollSchema = z.object({
  pollId: z.string(),
  applicationId: z.string(),
});
export type VoteOnPollSchema = z.infer<typeof VoteOnPollSchema>;

export const ResolvePollSchema = z.object({
  pollId: z.string(),
  winningApplicationId: z.string(),
});
export type ResolvePollSchema = z.infer<typeof ResolvePollSchema>;
...
export type PollFilterSchema = z.infer<typeof PollFilterSchema>;
...
export type LoyaltyRequestStatus =
  (typeof LoyaltyRequestStatus)[keyof typeof LoyaltyRequestStatus];
